        ...
        <div className="flex flex-col items-center bg-white w-full mx-5 h-80 rounded-lg shadow-md">
          ...
          <div className="flex flex-col items-center py-5 w-full h-full bg-gray-200">
            <div className="flex flex-col justify-center items-center mt-5 text-2xl">
              <h1 className=" font-bold text-zinc-700">{team1}</h1>
              <h1 className=" font-bold text-zinc-700">vs</h1>
              <h1 className="font-bold text-zinc-700">{team2}</h1>
            </div>
