...
import { CreateTeam } from "./Interaction";
		...
		<>
          ...
          <span className="text-[#B48325]">100</span>
			...
			<div className="flex justify-center items-center pb-5">
				...
				<button
					className="border-white py-2 px-5 border text-green-400 rounded-3xl hover:bg-green-600 hover:text-white"
